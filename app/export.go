...
// Export exports the state of the application for a genesis file.
func (app *App) Export(forZeroHeight bool, jailAllowedAddrs []string) (servertypes.ExportedApp, error) {
